...
## 2025-01-24: not needed, Lewis had data for week 9 when all flies were dead.
## added now.
...
# ggsurvplot( survfit(b_surv_obj ~ vial, data=b_surv_final))
...
#### combined figure 1 for ms submission
...
ggsave("./results/fig1.png", plot=fig1,
       width=col2, height=col2, unit="cm", dpi=300)
